...
function criptografar(){
  ...
  document.getElementById('output').innerHTML = '<textarea readonly id="input-texto">' + resultCripto + '</textarea>' + '<button class="bnt-copiar" id="copiar" onclick="copiar()">Copiar</button>'
}
